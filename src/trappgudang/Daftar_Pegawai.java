...
public class Daftar_Pegawai extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUsername.setToolTipText("Silahkan Masukkan User Name(Nama Pengguna)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
                String sql = "insert into db_pegawai values ('"+txtUsername.getText()+"','"+txtPassword.getText()+"')";
