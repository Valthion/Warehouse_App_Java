...
public class Daftar_Pemilik extends javax.swing.JFrame {
    private Connection con;
    private Statement stat;
    private ResultSet res;
    
    
    public Daftar_Pemilik() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Akun ADMIN / Purchasing");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
                String sql = "insert into db_admin values ('"+txtUsername.getText()+"','"+txtPassword.getText()+"')";
